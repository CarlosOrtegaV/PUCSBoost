...
df = pd.read_csv('expsetup_mainresults_sarpg.csv')
...
ap_models_ = ['ap_xgb_ce','ap_xgb_csboost','ap_xgb_pucsboost_scar_ek',
              'ap_xgb_nnpu_scar','ap_xgb_pucsboost_sarpg',
              'ap_xgb_nnpu_sarpg','ap_xgb_cspu_sarpg']
              
as_models_ = ['as_xgb_ce','as_xgb_csboost','as_xgb_pucsboost_scar_ek',
              'as_xgb_nnpu_scar','as_xgb_pucsboost_sarpg',
              'as_xgb_nnpu_sarpg','as_xgb_cspu_sarpg']

top1pre_models_ = ['top1perc_pre_xgb_ce','top1perc_pre_xgb_csboost','top1perc_pre_xgb_pucsboost_scar_ek',
              'top1perc_pre_xgb_nnpu_scar','top1perc_pre_xgb_pucsboost_sarpg',
              'top1perc_pre_xgb_nnpu_sarpg','top1perc_pre_xgb_cspu_sarpg']

top1sav_models_ =  ['top1perc_sav_xgb_ce','top1perc_sav_xgb_csboost','top1perc_sav_xgb_pucsboost_scar_ek',
              'top1perc_sav_xgb_nnpu_scar','top1perc_sav_xgb_pucsboost_sarpg',
              'top1perc_sav_xgb_nnpu_sarpg','top1perc_sav_xgb_cspu_sarpg']

ap_models_perdataset_ = ['ap_xgb_pucsboost_sarpg','ap_xgb_pucsboost_scar_ek',
                         'ap_xgb_cspu_sarpg','ap_xgb_csboost',
                         'ap_xgb_nnpu_sarpg','ap_xgb_nnpu_scar',
                         'ap_xgb_ce']
df_filtered.copy().groupby('dataset').mean().loc[datasets_, ap_models_perdataset_].transpose()

as_models_perdataset_ = ['as_xgb_pucsboost_sarpg','as_xgb_pucsboost_scar_ek',
                         'as_xgb_cspu_sarpg','as_xgb_csboost',
                         'as_xgb_nnpu_sarpg','as_xgb_nnpu_scar',
                         'as_xgb_ce']
