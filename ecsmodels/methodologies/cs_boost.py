        ...
        if self.obj == 'ce':
            ...
            if self.validation == True:
              xgboost = xgb.train(params=self.params, dtrain=dtrain, obj=puwce_train, 
                                  custom_metric=puwce_val, num_boost_round=500,
            ...
            xgboost = xgb.train(params=self.params, dtrain=dtrain, obj=pucano_train, 
                                custom_metric=pucano_val, num_boost_round=500,
                                early_stopping_rounds=50, evals=[(dval, 'eval')], 
                                verbose_eval=False)
            ...
            if self.validation == True:
              xgboost = xgb.train(params=self.params, dtrain=dtrain, obj=nnpu_train, 
                                  custom_metric=nnpu_val, num_boost_round=500,
                                  early_stopping_rounds=50, evals=[(dval, 'eval')], 
                                  verbose_eval=False)
            else:
            ...
            if self.validation == True:
              xgboost = xgb.train(params=self.params, dtrain=dtrain, obj=imbnnpu_train, 
                                  custom_metric=imbnnpu_val, num_boost_round=500,
                                  early_stopping_rounds=50, evals=[(dval, 'eval')], 
                                  verbose_eval=False)
            else:
            ...
            xgboost = xgb.train(params=self.params, dtrain=dtrain, obj=aec_train, custom_metric=aec_val, num_boost_round=500,
