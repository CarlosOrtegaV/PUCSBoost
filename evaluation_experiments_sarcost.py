...
df = pd.read_csv('expsetup_mainresults_sarcost.csv')
...
ap_models_ = ['ap_xgb_ce','ap_xgb_csboost','ap_xgb_pucsboost_scar_ek',
              'ap_xgb_nnpu_scar','ap_xgb_pucsboost_sarcost',
              'ap_xgb_nnpu_sarcost','ap_xgb_cspu_sarcost']
              
as_models_ = ['as_xgb_ce','as_xgb_csboost','as_xgb_pucsboost_scar_ek',
              'as_xgb_nnpu_scar','as_xgb_pucsboost_sarcost',
              'as_xgb_nnpu_sarcost','as_xgb_cspu_sarcost']

top1pre_models_ = ['top1perc_pre_xgb_ce','top1perc_pre_xgb_csboost','top1perc_pre_xgb_pucsboost_scar_ek',
              'top1perc_pre_xgb_nnpu_scar','top1perc_pre_xgb_pucsboost_sarcost',
              'top1perc_pre_xgb_nnpu_sarcost','top1perc_pre_xgb_cspu_sarcost']

top1sav_models_ =  ['top1perc_sav_xgb_ce','top1perc_sav_xgb_csboost','top1perc_sav_xgb_pucsboost_scar_ek',
              'top1perc_sav_xgb_nnpu_scar','top1perc_sav_xgb_pucsboost_sarcost',
              'top1perc_sav_xgb_nnpu_sarcost','top1perc_sav_xgb_cspu_sarcost']

ap_models_perdataset_ = ['ap_xgb_pucsboost_sarcost','ap_xgb_pucsboost_scar_ek',
                         'ap_xgb_cspu_sarcost','ap_xgb_csboost',
                         'ap_xgb_nnpu_sarcost','ap_xgb_nnpu_scar',
                         'ap_xgb_ce']
df_filtered.copy().groupby('dataset').mean().loc[datasets_, ap_models_perdataset_].transpose()

as_models_perdataset_ = ['as_xgb_pucsboost_sarcost','as_xgb_pucsboost_scar_ek',
                         'as_xgb_cspu_sarcost','as_xgb_csboost',
                         'as_xgb_nnpu_sarcost','as_xgb_nnpu_scar',
                         'as_xgb_ce']
